    ...
    <button
      ...
      className={`group relative flex w-full flex-col rounded-2xl border bg-surface-container-lowest p-4 text-left qc-soft-shadow transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
        selected
          ...
          : "border-on-surface/8 qc-soft-shadow-hover"
      }`}
    >
      <span
        aria-hidden
        className={`absolute right-3 top-3 grid h-7 w-7 place-items-center rounded-md transition-colors ${
          selected
            ? "bg-primary text-white"
            : "bg-surface-container text-transparent group-hover:text-on-surface/30"
        }`}
      >
      ...
      <span className="flex items-start gap-3 pr-10">
        <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-secondary-fixed text-on-secondary-fixed-variant">
      ...
      <span className="mt-3 flex flex-wrap items-center gap-2">
        {researched && (
          <span className="inline-flex w-fit items-center gap-1 rounded-md bg-tertiary-fixed px-2 py-0.5 font-[var(--font-label)] text-label-sm font-semibold text-on-tertiary-fixed-variant">
      ...
      <span
        className={`mt-4 inline-flex w-full items-center justify-center gap-1.5 rounded-md px-3 py-2 font-[var(--font-label)] text-label-md font-bold transition-colors ${
          selected
