  ...
  head: () => ({
    meta: [
      { title: "QuestCampus — Find the universities that actually fit you" },
      {
        name: "description",
        content:
          "Answer 5 questions. Get a personalized ranked list of universities — Safety, Target, Reach — with scholarships and deadlines. AI-matched in under a minute. Free to start, $15/mo to unlock all 20+.",
      },
