  ...
  head: () => ({
    meta: [
      { title: "QuestCampus" },
      {
        name: "description",
        content:
          "Answer 5 questions. Get a personalized ranked list of universities — Safety, Target, Reach — with scholarships and deadlines. AI-matched in under a minute. Free to start, $15 one-time to unlock all 20.",
      },
